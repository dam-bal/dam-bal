...
- [spatie/elasticsearch-query-builder](https://github.com/spatie/elasticsearch-query-builder) ([3.5.1](https://github.com/spatie/elasticsearch-query-builder/releases/tag/3.5.1), 2 weeks ago) - Build and execute an Elasticsearch search query using a fluent PHP API
- [elastic/go-elasticsearch](https://github.com/elastic/go-elasticsearch) ([v8.17.1](https://github.com/elastic/go-elasticsearch/releases/tag/v8.17.1), 3 weeks ago) - The official Go client for Elasticsearch
