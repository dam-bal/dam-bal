...
- [spatie/elasticsearch-query-builder](https://github.com/spatie/elasticsearch-query-builder) ([3.1.0](https://github.com/spatie/elasticsearch-query-builder/releases/tag/3.1.0), 2 weeks ago) - Build and execute an Elasticsearch search query using a fluent PHP API
- [dam-bal/eloquentity](https://github.com/dam-bal/eloquentity) ([0.5.3](https://github.com/dam-bal/eloquentity/releases/tag/0.5.3), 2 weeks ago) - Eloquent Entities
...
- [Nested query improvements](https://github.com/spatie/elasticsearch-query-builder/pull/53) on [spatie/elasticsearch-query-builder](https://github.com/spatie/elasticsearch-query-builder) (2 weeks ago)
