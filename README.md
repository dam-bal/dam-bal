...
- [elastic/go-elasticsearch](https://github.com/elastic/go-elasticsearch) ([v9.0.0](https://github.com/elastic/go-elasticsearch/releases/tag/v9.0.0), 3 days ago) - The official Go client for Elasticsearch
- [spatie/elasticsearch-query-builder](https://github.com/spatie/elasticsearch-query-builder) ([3.7.0](https://github.com/spatie/elasticsearch-query-builder/releases/tag/3.7.0), 6 days ago) - Build and execute an Elasticsearch search query using a fluent PHP API
