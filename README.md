...
- [spatie/elasticsearch-query-builder](https://github.com/spatie/elasticsearch-query-builder) ([3.5.0](https://github.com/spatie/elasticsearch-query-builder/releases/tag/3.5.0), 1 week ago) - Build and execute an Elasticsearch search query using a fluent PHP API
